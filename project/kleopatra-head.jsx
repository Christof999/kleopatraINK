/* global React */
// Kleopatra — real photo with 3D parallax tilt + depth layers following cursor.

const { useRef, useEffect, useState } = React;

function KleopatraHead({ style = 'classic', goldIntensity = 70 }) {
  ...
  // Style variants change visual treatment
  const filters = {
  ...
  return (
    <div style={{
      ...
      {/* Main photo — rotates with cursor for 3D feel */}
      <div style={{
        position: 'relative',
        width: '100%',
        height: '100%',
        ...
        {/* Soft edge vignette mask via shadow */}
        <div style={{
          position: 'absolute',
          inset: 0,
          borderRadius: '50%',
          ...
          {/* Gold overlay tint — intensifies with goldIntensity */}
          <div style={{
            position: 'absolute',
            inset: 0,
          ...
          {/* Dark vignette ring to blend into black page */}
          <div style={{
            position: 'absolute',
            inset: 0,
        ...
        {/* Subtle floating sparkle layer — depth cue, reacts most to cursor */}
        <div style={{
          position: 'absolute',
          inset: 0,
...
window.KleopatraHead = KleopatraHead;
