    ...
    <div className="page with-bg">
      ...
      <div className="legal-content">
        ...
        <section>
          ...
          <p>
            {t.booking.labelPhone}: <a className="legal-link" href="tel:+4998316842">+49 9831 6 84 21</a><br />
      ...
      <div className="legal-content">
        <section>
          ...
          <p>
            ...
            {t.booking.labelPhone}: <a className="legal-link" href="tel:+4998316842">+49 9831 6 84 21</a>
          </p>
        </section>
